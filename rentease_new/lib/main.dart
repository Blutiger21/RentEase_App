...
import 'package:rentease/services/chat_service.dart'; // <-- FIX 1: ADDED CHAT SERVICE IMPORT
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<ChatService>(create: (_) => ChatService(supabase)), // <-- FIX 2: CHAT SERVICE IS NOW DEFINED
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          // --- FIX 3: WRAP STYLE IN ElevatedButtonThemeData ---
